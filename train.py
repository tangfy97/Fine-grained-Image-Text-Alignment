...
def main():
    ...
    #change the data path as yours
    parser.add_argument('--data_name', default='/home/ljd/PycharmProjects/assignment_4_13/data',
    ...
    vocab = deserialize_vocab(os.path.join(opt.data_name, 'vocab.json'))
    #vocab = deserialize_vocab("/vocab.json")
    ...
    # Train the Model
    for epoch in range(start_epoch, opt.nums_epoch):
